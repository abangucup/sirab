    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="myModalLabel34">Modal Tambah Data Keluhan Pasien</h3>
            ...
            <form action="{{ route('kasus.store', ['pasien' => $pasien->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
