        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title font-medium-5">Dashboard Super Admin</h4>
                                            ...
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body text-white text-right align-self-center">
                                                        <span class="d-block mb-1 font-medium-1">Total Puskesmas</span>
                                                        <h1 class="text-white mb-0">{{ $totalPuskesmas }}</h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body text-white text-right align-self-center">
                                                        <span class="d-block mb-1 font-medium-1">Total Dinas</span>
                                                        <h1 class="text-white mb-0">{{ $totalDinas }}</h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body text-white text-right align-self-center">
                                                        <span class="d-block mb-1 font-medium-1">Total Pengguna</span>
                                                        <h1 class="text-white mb-0">{{ $totalUser }}</h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body text-white text-right align-self-center">
                                                        ...
                                                        <h1 class="text-white mb-0">{{ $totalSemuaJadwal }}</h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
