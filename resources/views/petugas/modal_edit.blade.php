<div class="modal fade text-left" id="modalUbah-{{ $petugas->id }}" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel34" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="myModalLabel34">Ubah Data Petugas</h3>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="form-group position-relative has-icon-left">
                                <input type="text" placeholder="Nama Lengkap" class="form-control" name="nama_lengkap"
                                    value="{{ old('nama_lengkap', $petugas->user->biodata->nama_lengkap) }}" required>
                            ...
                            <div class="form-group position-relative has-icon-left">
                                <input type="date" placeholder="Tanggal Lahir"
                                    value="{{ old('tanggal_lahir',$petugas->user->biodata->tanggal_lahir)}}" class="form-control"
                                    name="tanggal_lahir">
                                <div class="form-control-position">
                            ...
                            <div class="form-group position-relative has-icon-left">
                                <input type="text" placeholder="Nomor Telpon Aktif" class="form-control" name="telepon"
                                    value="{{ old('telepon', $petugas->user->biodata->telepon ?? null) }}">
                                <div class="form-control-position">
                                    <span>+62</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group position-relative has-icon-left">
                                <input type="text" placeholder="Alamat" class="form-control" name="alamat"
                                    value="{{ old('alamat', $petugas->user->biodata->alamat ?? null) }}" required>
                                <div class="form-control-position">
                            ...
                            <div class="form-group position-relative has-icon-left">
                                <select name="jenis_kelamin" class="form-control" required>
                                    <option value="{{ $petugas->user->biodata->jenis_kelamin }}" selected>{{
                                        $petugas->user->biodata->jenis_kelamin == 'l' ? 'Laki-Laki' : 'Perempuan' }}</option>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="form-group position-relative has-icon-left">
                                <input type="text" placeholder="Username" class="form-control" name="username"
                                    value="{{ $petugas->user->username }}" required>
                                <div class="form-control-position">
                                    <i class="ft-user font-medium-5 line-height-1 text-muted icon-align"></i>
                                </div>
                            </div>
                            ...
                            <div class="form-group position-relative has-icon-left">
                                <select name="role" class="form-control" required>
                                    <option value="{{ $petugas->user->role->id }}" selected>{{ $petugas->user->role->nama_role }}</option>
                                    <option value="" disabled>-- Pilih --</option>
                            ...
                            <div class="form-group position-relative has-icon-left">
                                <select name="instansi" class="form-control">
                                    @if ($petugas->user->instansi)
                                    <option value="{{ $petugas->user->instansi->id }}" selected>{{ $petugas->user->instansi->nama_instansi
                                        }}</option>
                                    @endif
                                    <option value="" disabled>-- Pilih --</option>
                            ...
                            <fieldset class="form-group">
                                ...
                                <img src="{{ $petugas->user->biodata->foto }}" height="150px" width="150px"
                                    class="border rounded-circle shadow" alt="">
                            </fieldset>
                        </div>
                    </div>
                </div>
